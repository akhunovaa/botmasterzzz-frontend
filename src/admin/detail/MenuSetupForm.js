    ...
    constructor(props) {
        ...
        this.state = {
            ...
            commandAnswerType: [
                ...
                {
                    key: 8,
                    text: 'Отправка случайного видео',
                    value: 'Отправка случайного видео из списка',
                },
                {
                    key: 9,
                    text: 'Сохранение аттрибута в базе данных',
                    value: 'Сохранение аттрибута в базе данных',
                },
                {
                    key: 10,
                    text: 'Получение аттрибута из базе данных',
                ...
                if (item) {
                    switch (id) {
                        ...
                        case 4:
                            ...
                            break;
                        case 2:
                            item.innerText = 'Для нескольких кнопок, в поле \'Команда для кнопки\' необходимо указать их разделяя знаком % и $.' +
                                'Пример: Главное меню$Новости$Личный кабинет%Контакты$Анекдоты$Информация';
                            break;
                        case 3:
                            item.innerText = 'Для нескольких кнопок, в поле \'Команда для кнопки\' необходимо указать их разделяя знаком % и $.' +
                                'Пример: Главное меню$Новости$Личный кабинет%Контакты$Анекдоты$Информация';
                ...
                if (item) {
                    switch (id) {
                        ...
                        case 6:
                            ...
                            break;
                        case 8:
                            item.innerText = 'Необходимо разделить ссылки на видео ' +
                                'в поле \'Ответ\' знаком %' +
                                'Пример: http://ex.com/video_1.mp4%http://ex.com/video_2.avi%http://ex.com/video_3.wav';
                            break;
                        case 0:
                            item.innerText = 'Необходимо выбрать тип сообщения';
                            break;
