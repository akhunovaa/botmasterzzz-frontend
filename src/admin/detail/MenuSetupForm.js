                ...
                if (item) {
                    switch (id) {
                        ...
                        case 4:
                            ...
                            break;
                        case 2:
                            item.innerText = 'Для нескольких кнопок, в поле \'Команда для кнопки\' необходимо указать их разделяя знаком %.' +
                                'Пример: Фотография%Узнать погоду%Личный кабинет%Информация';
                            break;
                        case 3:
                            item.innerText = 'Для нескольких кнопок, в поле \'Команда для кнопки\' необходимо указать их разделяя знаком %.' +
                            'Пример: Главное меню%Новости%Личный кабинет';
                            break;
                        case 6:
                            item.innerText = 'Необходимо разделить ссылки на изображения ' +
                                'в поле \'Ответ\' знаком %.' +
